...
class Jeu:
    ...
    def vaisseau_suppression(self):
        ...
        for ennemi in self.ennemis_liste:
            if ennemi[0] <= self.vaisseau1.vaisseau_x+8 and ennemi[1] <= self.vaisseau1.vaisseau_y+8 and ennemi[0]+8 >= self.vaisseau1.vaisseau_x and ennemi[1]+8 >= self.vaisseau1.vaisseau_y:
                self.ennemis_liste.remove(ennemi)
                self.explosions_creation( self.vaisseau1.vaisseau_x, self.vaisseau1.vaisseau_y)
